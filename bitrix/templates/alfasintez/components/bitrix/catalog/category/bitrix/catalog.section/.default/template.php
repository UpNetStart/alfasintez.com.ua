...
<div class="sub-category-menu-wrapper">
	<ul class="sub-category-menu clearfix">
		<li><a class="clearfix" href="#"><img src="'.SITE_TEMPLATE_PATH.'/images/folder.png" /> 	<h3 class="menu-points">  Блистерная упаковка</h3>	</a></li>
		<li><a class="clearfix" href="#"><img src="'.SITE_TEMPLATE_PATH.'/images/folder.png" />  <h3 class="menu-points">  Упаковка для яиц </h3> 	</a></li>
		<li><a class="clearfix" href="#"><img src="'.SITE_TEMPLATE_PATH.'/images/folder.png" />  <h3 class="menu-points">  Плёнка ПЕТФ	</h3> 	</a></li>
	</ul>
</div>
';
